...
(() => {
  ...
  function list() {
    ...
    host.innerHTML=`<div class="history-heading"><div><h2>Run history</h2><p>실행이 끝난 뒤에도 설정과 관측 기록을 다시 확인하세요. 저장된 snapshot을 조회하며, 실행 중인 작업의 실시간 상태는 아닙니다.</p></div><a class="button" href="docs/run-history.md">기록 보관 방법</a></div>
